...
public final class ClanWarStartEvent extends Event {
 private static final HandlerList HANDLERS=new HandlerList(); private final Player actor; private final String firstClan,secondClan;
 public ClanWarStartEvent(Player actor,String firstClan,String secondClan){this.actor=actor;this.firstClan=firstClan;this.secondClan=secondClan;}
