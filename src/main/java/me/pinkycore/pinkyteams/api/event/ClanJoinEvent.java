...
public final class ClanJoinEvent extends Event implements Cancellable {
    private static final HandlerList HANDLERS = new HandlerList();
    private final Player player; private final String clanName; private boolean cancelled;
    public ClanJoinEvent(Player player, String clanName) { this.player = player; this.clanName = clanName; }
