...
public class NameTagManager {
    ...
    private String bypassPermission = "pinkyteams.bypass.nametag";
    ...
    public NameTagManager(PinkyTeams plugin) {
        this.plugin = plugin;
    ...
    public void reload() {
        ...
        if (provider == Provider.TAB && obfuscateEnabled) {
            plugin.getLogger().warning("Obfuscacion de nametag con TAB activa: usa los placeholders rel_pinkyteams_nametag_obfuscate_* en TAB. Gestor interno desactivado.");
        }
