...
public class ClanNameHandler {
    ...
    private static int getMaxVisibleLength(PinkyTeams plugin) {
    ...
    public static void insertClan(PinkyTeams plugin, String rawName, String founder, String leader) {
    ...
    public static void updateClanName(PinkyTeams plugin, String oldName, String newRawName) {
        LangManager lang = plugin.getLangManager();
        int maxVisibleLength = getMaxVisibleLength(plugin);
